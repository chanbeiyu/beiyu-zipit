...
export default defineConfig({
  ...
  theme: {
    ...
    fontFamily: {
      title: ['Snell-Black', 'LXGWWenKaiLite-Medium', 'EarlySummer-Subset', 'EarlySummer', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
      navbar: ['STIX-Italic', 'LXGWWenKaiLite-Medium', 'EarlySummer-Subset', 'EarlySummer', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
      ...
      lxgw: ['STIX-Italic', 'LXGWWenKaiLite-Medium', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
    },
  },
  rules: [
    ['scrollbar-hidden', {
