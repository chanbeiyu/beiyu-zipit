...
export default defineConfig({
  ...
  theme: {
    colors: light,
    fontFamily: {
      title: ['Snell-Black', 'EarlySummer-Subset', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
      navbar: ['STIX-Italic', 'EarlySummer-Subset', 'ui-serif', 'Georgia', 'Cambria', 'Times New Roman', 'Times', 'serif'],
